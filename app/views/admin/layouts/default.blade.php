            ...
            <div class="container">
    			...
    			<div class="collapse navbar-collapse navbar-ex1-collapse">
    				<ul class="nav navbar-nav">
    					...
    					<li{{ (Request::is('admin/questions*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/questions') }}}"><span class="glyphicon glyphicon-bullhorn"></span> Questions</a></li>
    					<li{{ (Request::is('admin/choices*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/choices') }}}"><span class="glyphicon glyphicon-bullhorn"></span> Choices</a></li>
